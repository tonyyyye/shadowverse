...
$card = $game_u001.player1.draw.hand[0];
...
my $game_u002 = Game.new.init();
$game_u002.player2.load_deck('minions_only.deck');
$card1 = $game_u002.player2.draw.hand[*-1].be_played();
$card2 = $game_u002.player2.draw.hand[*-1].be_played();
ok $card1.attack($card2),
    ' UNIT_Card_TC_011       |Card attack Card ';
ok $card2.attack($game_u002.player2.Hero),
